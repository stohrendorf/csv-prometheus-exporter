...
/// </summary>
internal static class ColumnReaders
{
...
public class ColumnReadersTest
{
  ...
  {
    Assert.That(static () => ColumnReaders.Create("number", "bla"), Throws.Nothing);
    Assert.That(static () => ColumnReaders.Create("clf_number", "bla"), Throws.Nothing);
    Assert.That(static () => ColumnReaders.Create("request_header", "bla"), Throws.Nothing);
    Assert.That(static () => ColumnReaders.Create("label", "bla"), Throws.Nothing);
    Assert.That(static () => ColumnReaders.Create("xxx", "bla"), Throws.TypeOf<ArgumentOutOfRangeException>());
  }
}
